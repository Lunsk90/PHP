            ...
            <div class="row">
              ...
              <div id="activas" class="col s12">
                <table class="striped">
                  ...
                  <tbody>
                  <?php foreach($this->model->ListarUsuarioActivos() as $r): ?>
                      <tr>
                ...
                <table class="striped">
                  ...
                  <?php foreach($this->model->ListarUsuarioInactivos() as $r): ?>
                      <tr>
                          ...
                          <td class="center">
                              <a onclick="javascript:return confirm('¿Seguro que desea desactivar este registro?');" href="?c=Usuario&a=CambiarEstado&nuevo_estado=1&id=<?php echo $r->idusuario; ?>" title="Desactivar Registro" ><i class="small material-icons green-text">check_circle</i></a>
                          </td>
                      </tr>
                  <?php endforeach; ?>
                  </tbody>
