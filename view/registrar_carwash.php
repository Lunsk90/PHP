    ...
    <div class="section">
      ...
      <div class="row">
        <div class="col s12">
            ...
            <!-- formulario -->
            <div class="row">
              <form class="col s12" action="?c=Carwash&a=Guardar" method="post" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="input-field col s6">
                    <input id="txtTelefono" type="number" class="validate" name="txtTelefono"  required>
