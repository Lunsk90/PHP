...
class BoletousuarioController{
    ...
    public function Index(){
        ...
        require_once 'view/include/cabecera_usuario.1.php';
    ...
    public function VerHorarioss(){
        ...
        require_once 'view/mostrar_horario_pelicula_afuera.php';
        require_once 'view/include/pie.php';
    }
    ...
    public function DatosPago(){
        ...
        if(isset($_REQUEST['txtIdhorario'])){
           ...
           $cliente = $this->modelCliente->ObtenerCliente($_SESSION["id"]); 
           $usuario = $this->modelUsuario->ObtenerUsuario($_SESSION["id"]);     
            //AQUI HE MODIFICADO: $cliente = $this->modelCliente->ObtenerCliente(0);     
        }
    ...
    public function Facturar(){
        ...
        session_start();
      // LE cambie cliente por usuario =  $venta->idusuario = $_SESSION["id"];
        $venta->idusuario  = $_SESSION["id"]; #se toma el id del que inició sesión
        $venta->idcliente =  $_SESSION["id"];
        //aqui he modificado:  $venta->idcliente = 0;
   
      //  $venta->idcliente = $_SESSION["id"]; #es el cliente que se usa por defecto
